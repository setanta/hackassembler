 ...
 * AMD    1  1  1
 */
QByteArray Code::dest(const QByteArray& mnemonic)
{
    return QByteArray::number(mnemonic.count('A')) +
           QByteArray::number(mnemonic.count('D')) +
           QByteArray::number(mnemonic.count('M'));
}
 ...
 * JMP    1  1  1
 */
QByteArray Code::jump(const QByteArray& mnemonic)
{
    if (mnemonic == "JGT")
        return "001";
 ...
 *        D|A   0  1  0  1  0  1    D|M
 */
QByteArray Code::comp(const QByteArray& mnemonic)
{
    QByteArray code(7, '0');
